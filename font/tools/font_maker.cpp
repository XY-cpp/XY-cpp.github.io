    ...
    for(int i=1;i<=n;i++)
    {
        ...
        while(getline(cin,s))
        {
            ...
            printf( "                <label class=\"btn btn-info mr-2\">\n"
                    "                    <input type=\"radio\" name=\"d%d_t%d\" autocomplete=\"off\" value=\"1\">%s\n"
                    "                </label>\n",i,j,s.substr(p1,3).c_str());
            printf( "                <label class=\"btn btn-info mr-2\">\n"
                    "                    <input type=\"radio\" name=\"d%d_t%d\" autocomplete=\"off\" value=\"2\">%s\n"
                    "                </label>\n",i,j,s.substr(p2,3).c_str()); 
            cerr<<(p1<p2)+1;
            printf("            </div>\n");
            printf("        </div>\n");
